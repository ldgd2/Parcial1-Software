...
async def _llamar_gemini_vision(image_base64: str, prompt: str | None = None) -> dict:
    ...
    system_instruction = (
        ...
        "HERENCIA: Si detectas herencia en la imagen (flechas con punta triangular vacía apuntando al padre), usa el tipo de relación 'inheritance' (ej. {\"type\": \"inheritance\"}) en vez de 'association'.\n"
        "TIPOS DE RELACIÓN: Los únicos tipos válidos para relations son 'association', 'inheritance', 'composition', 'aggregation', 'dependency', 'realization' y 'association_class'.\n"
        "CLASE ASOCIACIÓN: SOLO SI detectas explícitamente clases intermedias (Association Class) unidas por una línea punteada a una relación, DEBES generar 3 elementos: 1) La relación principal (type: 'association') entre las clases principales. 2) Un nodo (type: 'class') para la clase intermedia. 3) Una relación (type: 'association_class') donde 'sourceId' es la clase intermedia y 'targetId' es el ID de la relación principal. ¡No la uses si es una relación normal!\n"
