...
async def _llamar_gemini_vision(image_base64: str, prompt: str | None = None) -> dict:
    ...
    system_instruction = (
        ...
        "Formato exacto de atributo: 'nombre: tipo' (ejemplo: 'id: int', 'nombre: string').\n"
        "Formato exacto de método: 'nombre(parametros): retorno' (ejemplo: 'guardar(): void', 'obtenerPorId(id: int): Estudiante').\n"
