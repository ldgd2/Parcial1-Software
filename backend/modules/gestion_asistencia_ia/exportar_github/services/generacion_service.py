...
async def generar_spring_boot(
    ...
    # Fase 1: Parsing
    api_docs_md = parsear_diagrama(diagram_json, temp_dir, nombre_repo, db_password, url_base, descripcion_proyecto)
    ...
    await inyectar_logica_ia(temp_dir, diagram_json, descripcion_proyecto)
