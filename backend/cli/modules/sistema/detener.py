...
def ejecutar():
    console.print('[yellow]Detener Servicio Systemd[/yellow]')
    ...
    op = Prompt.ask("Selecciona el servicio a detener", default="1")
    try:
        ...
        console.print(f"[bold green]✔ {seleccionado} detenido correctamente.[/bold green]")
