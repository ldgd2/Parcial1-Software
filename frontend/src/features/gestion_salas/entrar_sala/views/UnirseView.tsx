...
export const UnirseView: React.FC = () => {
  ...
  return (
    <div className="unirse-view">
      ...
      <div className="unirse-bg-grid" />
      <div className="unirse-orb unirse-orb-primary" />
      <div className="unirse-orb unirse-orb-secondary" />

      {/* Floating Particles */}
      <div className="unirse-particles">
      ...
      <div className="unirse-card">
        ...
        {/* Sonar Radar Container around Icon */}
        <div className="unirse-radar-wrap">
          ...
          <div className={`unirse-card__icon-wrapper unirse-card__icon-wrapper--${status}`}>
            {status === 'loading' && (
              <svg className="unirse-card__svg-icon spin" width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M21 12a9 9 0 1 1-6.219-8.56"/>
              </svg>
            )}
            {status === 'aprobado' && (
              <svg className="unirse-card__svg-icon pulse" width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                <polyline points="22 4 12 14.01 9 11.01"/>
              </svg>
            )}
            {status === 'pendiente' && (
              <svg className="unirse-card__svg-icon pulse-glow" width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <circle cx="12" cy="12" r="9"/>
                <path d="M12 7v5l3 3"/>
              </svg>
            )}
            {status === 'error' && (
              <svg className="unirse-card__svg-icon shake" width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
        ...
        {status === 'loading' && (
          <div className="unirse-card__body">
            ...
            <p>Sincronizando cliente con el canal de tiempo real WebSocket.</p>
          </div>
        )}
        ...
        {status === 'aprobado' && (
          <div className="unirse-card__body">
            ...
            <p>Ingresando a la sala de modelado UML <strong>{proyectoNombre}</strong>...</p>
          ...
          <div className="unirse-card__body">
            ...
            {nickname && (
              <div className="unirse-user-pill">
                ...
                <span>Colaborador: <strong>{nickname}</strong></span>
              </div>
            )}
